...
<img
  class="modify-img"
  data-image-small="./themes/cms/assets/images/static/footer-img.jpg"
  data-image-large="./themes/cms/assets/images/static/footer-img.jpg"
  data-image-standard="./themes/cms/assets/images/static/footer-img.jpg"
  data-src=""
...
<div class="container">
  <div class="row">
    <div class="col-md-5 Footer__top-left">
      ...
      <p>
        EMAIL:
        <a href="mailto:hello@edisonrealestatebd.com"
          >hello@edisonrealestatebd.com</a
        >
      </p>
    </div>
